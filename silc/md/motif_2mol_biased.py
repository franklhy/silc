...
from silc.md.collective_variables import DistancePBC
...
if restart and restart_file is not None:
    ...
    cv = [DistancePBC([indices_0, indices_1], box),]
    grid = Grid(lower=(0.3,), upper=(2.3,), shape=(64,))
    cv_restraints = CVRestraints(lower=(0.3,), upper=(2.3,), ku=100, kl=100)
