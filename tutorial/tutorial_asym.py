...
core_smiles = "[1*]C[NH2+]Cc6ccc(c2ccc3ccc5c(c1ccc(O[2*])cc1)ccc4ccc2c3c45)cc6"
...
bm.set_work_path("molecules_tutorial_asym")
#bm.clear_work_path()
bm.create_binding_motif(solvate=False)
#bm.create_binding_motif(solvate=True)
#bm.create_binding_motif(solvate=True, nmol=2, translate=[0,10,10])
bm.create_ditopic_molecule(solvate=False)
...
c = complex()
c.set_work_path("complexes_tutorial_asym")
c.clear_work_path()
