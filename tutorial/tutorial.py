...
#d.run(n_ligand=1)
#d.run(n_ligand=2)
d.load_results(files('silc.data.tutorial.docking.symmetric_core').joinpath('GCDOH_2_ligand_ad4.pdbqt'), n_ligand=2)
...
c.set_dock(d)
#c.create_receptor_motif_complex(n_motif=2, dock_pose_id=0, solvate=True)    # parrallel, "gauche"
